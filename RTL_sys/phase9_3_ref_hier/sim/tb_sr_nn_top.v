...
module tb_sr_nn_top;
    ...
    initial begin
        ...
        fd_result = $fopen("C:/M11413047/codex/final_proj/model_lite/sr_core/RTL_sys/phase9_3_ref_hier/results/tb_sr_nn_top_result.txt", "w");
        fd_stream_dump = $fopen("C:/M11413047/codex/final_proj/model_lite/sr_core/RTL_sys/phase9_3_ref_hier/results/conv1_to_conv3_stream_dump.txt", "w");
        ...
        $fdisplay(fd_result, "Phase9.3 sr_nn_top reference-like hierarchy verification result");
        $fdisplay(fd_result, "==============================================================");
        $fdisplay(fd_result, "Purpose : controller + ROM IP + Conv1 + slice + Conv3 + RAM ports at top level");
        ...
        fd_conv3_dump  = $fopen("C:/M11413047/codex/final_proj/model_lite/sr_core/RTL_sys/phase9_3_ref_hier/results/conv3_feature_ram_dump.txt", "w");
        fd_output_dump = $fopen("C:/M11413047/codex/final_proj/model_lite/sr_core/RTL_sys/phase9_3_ref_hier/results/output_image_ram_dump.txt", "w");
