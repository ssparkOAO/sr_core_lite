...
module tb_sr_core_top_mem_wrapper;
    ...
    initial begin
        ...
        fd_result       = $fopen("model_lite/sr_core/RTL_sys/phase8_weight_memory/tb_sr_core_top_mem_wrapper_result.txt", "w");
        ...
        $fdisplay(fd_result, "Phase8.2 sr_core_top_mem_wrapper verification result");
        $fdisplay(fd_result, "==================================================");
        $fdisplay(fd_result, "Purpose : memory-oriented wrapper around verified sr_core_top");
        ...
        for (i = 0; i < CONV1_WEIGHT_N; i = i + 1) begin
            ...
            dut.conv1_weight_mem[i] = temp_value[7:0];
        end
        ...
        for (i = 0; i < CONV3_WEIGHT_N; i = i + 1) begin
            ...
            dut.conv3_weight_mem[i] = temp_value[7:0];
        end
        ...
        fd_dump0 = $fopen("model_lite/sr_core/RTL_sys/phase8_weight_memory/feature_mem0_dump.txt", "w");
        fd_dump1 = $fopen("model_lite/sr_core/RTL_sys/phase8_weight_memory/feature_mem1_dump.txt", "w");
        fd_dump2 = $fopen("model_lite/sr_core/RTL_sys/phase8_weight_memory/feature_mem2_dump.txt", "w");
